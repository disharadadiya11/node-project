...
const {
  createSubjectJoiValidation,
  updateSubjectJoiValidation,
...
router.post(
  ...
  validateSchema(createSubjectJoiValidation, "body"),
...
router.put(
  "/update/:id",
  checkRoleMiddleware(["admin", "staff"]),
  validateSchema(updateSubjectJoiValidation, "body"),
  UpdateSubject.controller
);
